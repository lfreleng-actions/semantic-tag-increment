...
class SemanticVersion:
    ...
    SEMVER_PATTERN = re.compile(
        ...
        re.ASCII  # Use ASCII flag for performance with ASCII-only version strings.
                  # Note: This flag is not suitable for version strings containing Unicode characters.
    )
