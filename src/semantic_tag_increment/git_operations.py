...
class GitOperations:
    ...
    @staticmethod
    def get_existing_tags(path_prefix: str = ".", fetch_remote: bool = True, use_cache: bool = True) -> Set[str]:
        """
        ...
        cache_key = f"{validated_path}:{fetch_remote}"
        ...
        tags = GitOperations._get_tags_with_gitpython(validated_path, fetch_remote)
    ...
    @staticmethod
    def _get_tags_with_gitpython(path_prefix: str, fetch_remote: bool = True) -> Set[str]:
        ...
        try:
            ...
            if fetch_remote and repo.remotes:
                try:
                    repo.remotes.origin.fetch(tags=True, timeout=30)
