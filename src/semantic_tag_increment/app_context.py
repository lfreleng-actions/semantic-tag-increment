...
This module handles application context detection and configuration for different
execution modes (CLI vs GitHub Actions).
"""
...
class GitHubActionsConfig:
    ...
    def validate_required_inputs(config: dict[str, str | None]) -> None:
        ...
        """
        # Note: Tag validation is now handled by mode-specific validation
        # in ModeValidator, so we don't enforce it here anymore
        pass
